...
const file_proto_productcatalog_proto_rawDesc = "" +
	"\n" +
	"\x1aproto/productcatalog.proto\x12\vhipstershop\"\a\n" +
	"\x05Empty\"X\n" +
	"\x05Money\x12#\n" +
	...
	"\x0eSearchProducts\x12\".hipstershop.SearchProductsRequest\x1a#.hipstershop.SearchProductsResponse\"\x00B+Z)product-catalog-service/internal/genprotob\x06proto3"

var (
	file_proto_productcatalog_proto_rawDescOnce sync.Once
	file_proto_productcatalog_proto_rawDescData []byte
)

func file_proto_productcatalog_proto_rawDescGZIP() []byte {
	file_proto_productcatalog_proto_rawDescOnce.Do(func() {
		file_proto_productcatalog_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_productcatalog_proto_rawDesc), len(file_proto_productcatalog_proto_rawDesc)))
	})
...
var file_proto_productcatalog_proto_goTypes = []any{
...
func file_proto_productcatalog_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_productcatalog_proto_rawDesc), len(file_proto_productcatalog_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
